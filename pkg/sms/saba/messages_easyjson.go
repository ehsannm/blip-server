...
func easyjson66c1e240DecodeGitRonaksoftwareComBlipServerPkgSmsSaba(in *jlexer.Lexer, out *UnsubscribeResponse) {
...
func easyjson66c1e240EncodeGitRonaksoftwareComBlipServerPkgSmsSaba(out *jwriter.Writer, in UnsubscribeResponse) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Status != "" {
...
func (v UnsubscribeResponse) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
...
func (v UnsubscribeResponse) MarshalEasyJSON(w *jwriter.Writer) {
	easyjson66c1e240EncodeGitRonaksoftwareComBlipServerPkgSmsSaba(w, v)
}

// UnmarshalJSON supports json.Unmarshaler interface
func (v *UnsubscribeResponse) UnmarshalJSON(data []byte) error {
...
func (v *UnsubscribeResponse) UnmarshalEasyJSON(l *jlexer.Lexer) {
...
func easyjson66c1e240Decode1(in *jlexer.Lexer, out *struct {
	...
	for !in.IsDelim('}') {
		...
		case "errorInfo":
			easyjson66c1e240Decode2(in, &out.ErrorInfo)
		default:
			in.SkipRecursive()
		}
		in.WantComma()
...
func easyjson66c1e240Encode1(out *jwriter.Writer, in struct {
	...
	if true {
		...
		easyjson66c1e240Encode2(out, in.ErrorInfo)
	}
	out.RawByte('}')
}
...
func easyjson66c1e240Encode2(out *jwriter.Writer, in struct {
	...
	if in.Description != "" {
		const prefix string = ",\"errorDescription\":"
		if first {
			first = false
			out.RawString(prefix[1:])
		} else {
...
func easyjson66c1e240DecodeGitRonaksoftwareComBlipServerPkgSmsSaba1(in *jlexer.Lexer, out *SubscribeResponse) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "operator_response":
			easyjson66c1e240Decode3(in, &out.OperatorResponse)
		default:
			in.SkipRecursive()
		}
		in.WantComma()
...
func easyjson66c1e240EncodeGitRonaksoftwareComBlipServerPkgSmsSaba1(out *jwriter.Writer, in SubscribeResponse) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Status != "" {
	...
	if true {
		...
		easyjson66c1e240Encode3(out, in.OperatorResponse)
	}
	out.RawByte('}')
}
...
func easyjson66c1e240Decode3(in *jlexer.Lexer, out *struct {
	...
	for !in.IsDelim('}') {
		...
		switch key {
		case "statusInfo":
			easyjson66c1e240Decode4(in, &out.StatusInfo)
		default:
			in.SkipRecursive()
		}
		in.WantComma()
...
func easyjson66c1e240Encode3(out *jwriter.Writer, in struct {
	...
	if true {
		...
		first = false
		out.RawString(prefix[1:])
		easyjson66c1e240Encode4(out, in.StatusInfo)
	}
	out.RawByte('}')
}
...
func easyjson66c1e240DecodeGitRonaksoftwareComBlipServerPkgSmsSaba2(in *jlexer.Lexer, out *SendSmsResponse) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson66c1e240EncodeGitRonaksoftwareComBlipServerPkgSmsSaba2(out *jwriter.Writer, in SendSmsResponse) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Status != "" {
...
func easyjson66c1e240DecodeGitRonaksoftwareComBlipServerPkgSmsSaba3(in *jlexer.Lexer, out *ConfirmResponse) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "status_code":
			out.StatusCode = string(in.String())
		case "operator_response":
			easyjson66c1e240Decode5(in, &out.OperatorResponse)
		default:
			in.SkipRecursive()
		}
		in.WantComma()
...
func easyjson66c1e240EncodeGitRonaksoftwareComBlipServerPkgSmsSaba3(out *jwriter.Writer, in ConfirmResponse) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Status != "" {
	...
	if true {
		...
		easyjson66c1e240Encode5(out, in.OperatorResponse)
	}
	out.RawByte('}')
}
...
func (v ConfirmResponse) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson66c1e240EncodeGitRonaksoftwareComBlipServerPkgSmsSaba3(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *ConfirmResponse) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson66c1e240DecodeGitRonaksoftwareComBlipServerPkgSmsSaba3(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *ConfirmResponse) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson66c1e240DecodeGitRonaksoftwareComBlipServerPkgSmsSaba3(l, v)
}
func easyjson66c1e240Decode5(in *jlexer.Lexer, out *struct {
	...
	for !in.IsDelim('}') {
		...
		switch key {
		case "statusInfo":
			easyjson66c1e240Decode6(in, &out.StatusInfo)
		default:
			in.SkipRecursive()
		}
		in.WantComma()
...
func easyjson66c1e240Encode5(out *jwriter.Writer, in struct {
	...
	if true {
		...
		first = false
		out.RawString(prefix[1:])
		easyjson66c1e240Encode6(out, in.StatusInfo)
	}
	out.RawByte('}')
}
